...
public class EstacionesLista implements RepositorioEstaciones {
    ...
    public void añadeEjemplos() {
        añade(new com.example.zapstation.Estacion("Escuela Politécnica Superior de Gandía",
                ...
                com.example.zapstation.TipoEstacion.EDUCACION, 962849300, "http://www.epsg.upv.es",
                "Uno de los mejores lugares para formarse.", 3));
        añade(new com.example.zapstation.Estacion("Al de siempre",
                "P.Industrial Junto Molí Nou - 46722, Benifla (Valencia)",
                -0.190642, 38.925857, com.example.zapstation.TipoEstacion.BAR, 636472405, "",
        ...
        añade(new com.example.zapstation.Estacion("Ajuntament de Sueca",
                ...
                "Mal lloc pa carregar el coche.", 4));
        añade(new com.example.zapstation.Estacion("androidcurso.com",
                "ciberespacio", 0.0, 0.0, com.example.zapstation.TipoEstacion.EDUCACION,
                962849300, "http://androidcurso.com",
                "Amplia tus conocimientos sobre Android.", 5));
        añade(new com.example.zapstation.Estacion("Barranco del Infierno",
                "Vía Verde del río Serpis. Villalonga (Valencia)",
                -0.295058, 38.867180, com.example.zapstation.TipoEstacion.NATURALEZA, 0,
                "http://sosegaos.blogspot.com.es/2009/02/lorcha-villalonga-via-"+
                        "verde-del-rio.html","Espectacular ruta para bici o andar", 4));
        añade(new Estacion("La Vital",
                "Avda. de La Vital, 0 46701 Gandía (Valencia)", -0.1720092,
                38.9705949, TipoEstacion.COMPRAS, 962881070,
